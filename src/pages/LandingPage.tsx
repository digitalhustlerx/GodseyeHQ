      ...
      <section className="px-4 max-w-2xl mx-auto">
        <div className="bg-gradient-to-br from-[#0A0A0A] to-[#121212] border border-white/10 rounded-3xl p-8 md:p-12 text-center space-y-6 relative overflow-hidden shadow-xl">
          ...
          <div className="space-y-3 max-w-md mx-auto">
            <a href="https://app.digitalhustlerx.com/signup" className="block w-full bg-[#C4A484] hover:bg-[#b59574] text-black px-8 py-4 rounded-full font-bold text-xs uppercase tracking-widest transition-all shadow-md cursor-pointer text-center">
              Get Started →
            </a>
